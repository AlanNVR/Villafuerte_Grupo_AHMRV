...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{img/casos_uso_general.png}
...
\hline
\textbf{Requisitos} & \id{RF-26}, \id{RF-27}, \id{RF-34} \\ \hline
\textbf{Actores} & Primario: administrador general. \\ \hline
...
\hline
\textbf{Requisitos} & \id{RF-29}, \id{RL-04} \\ \hline
...
\textbf{Excepción E2} & El valor unitario de la labor no está configurado: el sistema muestra el avance en unidades y omite la estimación monetaria, indicando el motivo. \\ \hline
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{img/clases_refinado.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{img/secuencia_CU01.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{img/secuencia_CU03.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{img/secuencia_CU06.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{img/actividad_ciclo_semanal.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.78\textwidth]{img/estados_racimo.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{img/estados_alerta.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{img/componentes.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{img/despliegue.png}

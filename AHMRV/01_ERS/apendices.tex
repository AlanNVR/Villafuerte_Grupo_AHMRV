...
\id{EV-02} & 21 & 9 & 33 & Alta redundancia con \id{EV-01} \\ \hline
\id{EV-03} & 14 & 6 & 39 & Aporta el dominio de la polinización \\ \hline
\id{EV-04} & 26 & \textbf{17} & 56 & \textbf{Repunte}: dominio nuevo (calidad en extractora) \\ \hline
\id{EV-05} & 9 & 2 & 58 & Confirma el registro manual \\ \hline
\id{EV-06} & 11 & 3 & 61 & Aporta la perspectiva de remuneración \\ \hline
\id{EV-07} & 15 & 5 & 66 & Aporta la latencia de verificación \\ \hline
\id{EV-08} & 18 & 2 & 68 & Triangula \id{EV-04}; casi sin códigos nuevos \\ \hline
...
\id{EV-03}, lo que sugería saturación al cierre de la primera ronda. El repunte de \id{EV-04}
(17 códigos nuevos) demuestra que dicha saturación era \textbf{aparente}: correspondía al
agotamiento de un dominio ---el manejo del cultivo--- y no del problema completo. La incorporación
de la organización externa abrió un dominio no explorado.

La caída pronunciada en \id{EV-08} (2 códigos nuevos), pese a pertenecer al mismo dominio nuevo,
indica que ese dominio sí alcanzó saturación con dos fuentes. Este comportamiento ---saturación por
dominio y no por número absoluto de entrevistas--- es coherente con la distinción entre saturación
de código y saturación de significado de Hennink \emph{et al.} \cite{hennink2017}, y se reportará
como hallazgo metodológico en el manuscrito.
